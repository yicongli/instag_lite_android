 ...
 */
public class BluetoothPictureServices {
    // Debugging
    private static final String TAG = "BluetoothPictureService";

    // Name for the SDP record when creating server socket
    private static final String NAME_SECURE = "BluetoothPictureSecure";
    private static final String NAME_INSECURE = "BluetoothPictureInsecure";
    ...
    /**
     * Constructor. Prepares a new BluetoothPicture session.
     *
     * @param context The UI Activity Context
     * @param handler A Handler to send messages back to the UI Activity
     */
    public BluetoothPictureServices(Context context, Handler handler) {
    ...
    /**
     * Update UI title according to the current state of the Picture connection
     */
    ...
    /**
     * Start the Picture service. Specifically start AcceptThread to begin a
    ...
    private void connectionFailed() {
        ...
        BluetoothPictureServices.this.start();
    }
    ...
    private class AcceptThread extends Thread {
        ...
        public void run() {
            ...
            while (mState != STATE_CONNECTED) {
                ...
                if (socket != null) {
                    synchronized (BluetoothPictureServices.this) {
                        switch (mState) {
                            case STATE_LISTEN:
