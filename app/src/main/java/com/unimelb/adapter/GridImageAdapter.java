...
import com.unimelb.utils.SquareImageView;

import java.util.ArrayList;

/**
 * The adapter to handle the image view in grid image
 */
public class GridImageAdapter extends ArrayAdapter {
    ...
    private String mAppend;             // the append before the path
    ...
    /**
     * the item to hold the image in Grid
     */
